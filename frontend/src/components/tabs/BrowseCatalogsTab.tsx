...
function BrowseCatalogsTab() {
  return (
    <div style={{ display: 'flex', height: '100%' }}>
      <BrowseCatalogsSidebar />
      <BrowseCatalogsContent />
    </div>
  );
}

BrowseCatalogsTab.Sidebar = BrowseCatalogsSidebar;
BrowseCatalogsTab.Content = BrowseCatalogsContent;
