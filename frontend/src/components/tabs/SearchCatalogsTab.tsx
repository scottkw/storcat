...
function SearchCatalogsTab() {
  return (
    <div style={{ display: 'flex', height: '100%' }}>
      <SearchCatalogsSidebar />
      <SearchCatalogsContent />
    </div>
  );
}

SearchCatalogsTab.Sidebar = SearchCatalogsSidebar;
SearchCatalogsTab.Content = SearchCatalogsContent;
