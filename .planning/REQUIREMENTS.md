...
- [x] **PKG-02**: NSIS installer adds install directory to system PATH via `EnvVarUpdate`
- [x] **PKG-03**: `storcat version` works from any new terminal after Homebrew install (macOS)
- [x] **PKG-04**: `storcat version` works from any new terminal after WinGet install (Windows)
