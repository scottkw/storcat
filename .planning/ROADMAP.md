...
- [ ] 27-05-PLAN.md — Delete-confirmation dialog with its error sub-state, plus the duplicate and delete menu wiring (wave 3)
...
| 27. Catalog Actions + Watch | v3.0.0 | 4/7 | In Progress|  |
